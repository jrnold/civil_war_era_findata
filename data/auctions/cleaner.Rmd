...
Proposals invited on April 17, 1848 [Bayley, p. 146](https://books.google.com/books?id=Ce4JAAAAIAAJ&pg=PA146)
...
bids_1848  <- auction_1848  %>%
    ...
    mutate(auction = "1848-04-1; Loan of 1848",
           coupon_yield = 6 / price,
           ytm = make_auction_yields(price, "us_6pct_1868_jul", as.Date("1848-4-17")))

```

# Auction of Feb 9, 1847

Proposals invited Feb 9, 1847 [Bayley, p. 146](https://books.google.com/books?id=Ce4JAAAAIAAJ&pg=PA146)

```{r}
auction_1847_meta <- 
  data_frame(name = "1848-02-09; Loan of 1847",
             announcement = as.Date("1848-02-09"),
...
bids_1847 <- auction_1847  %>%
    ...
    mutate(auction = "1847-02-09; Loan of 1847",
           coupon_yield = 6 / price,
           yield = make_auction_yields(price, "us_6pct_1868_jan", as.Date("1847-2-9")))
